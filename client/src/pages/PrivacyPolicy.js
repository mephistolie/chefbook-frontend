...
const Home = () => {
    return (<Container>
        <Col style={{marginTop: "64px", marginBottom: "96px"}}>
            ...
            <p>
                Mikhail Levin built the ChefBook app as
                an Open Source app. This SERVICE is provided by
                Mikhail Levin at no cost and is intended for use as
                is.
            </p>
            <p>
            ...
            <p>
                ...
                ChefBook unless otherwise defined in this Privacy Policy.
            </p>
            <p><strong>Information Collection and Use</strong></p>
            <p>
                For a better experience, while using our Service, I
                may require you to provide us with certain personally
                identifiable information, including but not limited to email, name, nickname, avatar, Google ID, VK ID.
                The
                information that
            ...
            <p>This policy is effective as of 2023-04-10</p>
            <p><strong>Contact Us</strong></p>
            <p>
                If you have any questions or suggestions about my
                Privacy Policy, do not hesitate to contact me at support@chefbook.space.
            </p>
